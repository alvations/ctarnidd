...
`CRWV` CoreWeave · `NVDA` Nvidia (backer, supplier and backstop customer) · `MSFT` Microsoft (~two-thirds of 2025 revenue) · `META` Meta ($21B contract) · `BTC` bitcoin (the business it used to be).
