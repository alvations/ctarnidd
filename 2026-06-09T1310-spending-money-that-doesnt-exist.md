...
*OpenAI has filed to go public at up to a trillion dollars. It loses fourteen billion a year, has promised more than a trillion in spending it cannot afford, and sits at the center of a circle in which its suppliers fund it to buy their own machines. The public is being invited to hold the bag at the bottom.*

**Related tickers:** `MSFT` (Microsoft — 27% owner, cloud landlord) · `NVDA` (Nvidia — $100B backer) · `ORCL` (Oracle — Stargate compute) · `AMD` (chips) · `BTC` (the speculative tide it rides).

---

On a Monday in June, in a blog post written in the calm register of a company announcing a milestone rather than crossing a Rubicon, OpenAI confirmed what Wall Street had spent weeks anticipating: it has filed, confidentially, to go public. Goldman Sachs and Morgan Stanley are steering. The targeted debut is the fall. The targeted valuation runs from $730 billion to as much as **one trillion dollars** — which would make the most famous company of the artificial-intelligence age also one of the most valuable ever to ask the public for money.
...
Consider Oracle, reportedly preparing to spend tens of billions buying hundreds of thousands of Nvidia GPUs in order to lease them to OpenAI — a middleman taking on the capital risk so OpenAI can keep the spending off its own balance sheet as an operating expense. Consider AMD, supplying chips for gigawatts of future capacity under an arrangement that reportedly hands OpenAI warrants over AMD's own stock, so that the buyer profits if the supplier's shares rise on the news of the buyer's orders. Consider Microsoft, which owns roughly **27%** of OpenAI, sells it the cloud capacity it runs on, and has separately capped the revenue-share OpenAI owes it at **$38 billion** through 2030. Investor, supplier, customer, landlord — the same handful of names recur in every role, passing the same swelling sums among themselves, each transaction booked as validation of the next.

None of these arrangements is hidden. All of them are, individually, defensible. But step back and the aggregate is a closed financial ecosystem in which the leading indicator of "demand" is a small club of giants agreeing to finance one another's purchases of one another's products. It is the purest expression of a pattern visible across the whole AI boom — and OpenAI is not a node in that circle. It is the hub.
...
None of this is a prediction that OpenAI fails. The revenue growth is genuinely without precedent — from roughly $2 billion annualized at the end of 2023 to north of $20 billion two years later, faster than the companies that defined the internet and the smartphone. The technology is real, the demand is real, and it is entirely possible that the models keep improving and the spending eventually finds its return. The bulls are not fools. They are betting that the most important company of the age grows into a valuation that today exceeds its revenue fiftyfold.

But notice what the structure asks of the people at the bottom of it. The public is invited to supply the capital for $1.4 trillion of promises a $20-billion company cannot keep, in a business whose demand is substantially the sound of a few giants financing one another, inside a corporate shell engineered so that control stays with a nonprofit and the profits can be waved away in the mission's name — and to do so at up to a trillion dollars, in the same season that every insider with comparable paper is racing to convert theirs into cash.

When a company tells you, through its own chief executive, that it has promised to spend money that does not yet exist, and then asks you for some of yours, the honest thing is to take it at its word. The spending is real. The losses are real. The circle is real. The only open question is who is holding it when the music slows — and the structure has already answered that, in advance, in writing. It is not the nonprofit, and it is not the suppliers, and it is not the insiders.
