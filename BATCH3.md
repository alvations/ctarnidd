...
| # | status | slug | focus |
|---|--------|------|-------|
| 1 | pending | TBD-single-point-of-failure.md        | TSMC (TSM) — Taiwan concentration / single point of failure |
| 2 | pending | TBD-the-one-machine.md                | ASML — EUV lithography monopoly + China export controls |
| 3 | pending | TBD-the-custom-job.md                 | Broadcom (AVGO) — custom AI silicon / hyperscaler ASIC backlog |
| 4 | pending | TBD-the-house-always-wins.md          | Robinhood (HOOD) — PFOF, options/crypto churn, gamified retail |
