...
## The first crack in the renewal rate

Which brings us to a small but important development that the headline numbers gloss over: the renewal rate, the
single most important metric for a subscription business, has begun to show the first faint signs of erosion.
For years, Costco's renewal rates marched only upward, reaching records around 93% in North America — a figure
that signified an almost unbreakable customer bond. But the most recent reporting notes the first hints of
softening, which Costco attributes to a mix shift: a growing share of newer members are signing up digitally or
through promotions, and these members historically renew at slightly lower rates than the traditional in-warehouse
member.

Now, this is a small effect, and it would be alarmist to treat a fractional dip in a 90%-plus renewal rate as a
crisis — it is not. But it matters disproportionately because of the valuation. When a stock trades at a normal
retail multiple, a tiny wobble in renewal rates is a footnote. When a stock trades at fifty times earnings on the
premise that its membership model is a perpetual, ever-strengthening annuity, the *first evidence that the
annuity is not strengthening forever* is more significant than its size suggests — because the premium multiple
is, in effect, a bet that the renewal rate and the membership growth never disappoint. The crack does not have to
be large to matter when the price assumes there will be no crack at all. The market has priced perfection into
the one number that has just, for the first time in a long while, ticked the wrong way.
...
Somewhere a renewal rate ticks down a tenth of a percent for the first time in memory, and the question is not
whether Costco is wonderful — it is — but whether wonderful, at fifty times, was ever the same thing as cheap.
