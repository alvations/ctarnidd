...
| 5 | pending | TBD-carvana.md             | Carvana (CVNA) — back from the dead, balance sheet still buried [WSB] |
| 6 | pending | TBD-bnpl.md                | BNPL (AFRM/Klarna) — phantom consumer debt nobody can see [Engadget/CNET] |
