...
subprime-heavy end of the market — and watch their credit losses, which is where the phantom debt eventually
becomes visible. Klarna, the Swedish BNPL giant, provides the clearest early reading. In a recent quarter Klarna
reported that its consumer credit losses rose 17% even as revenue surpassed $700 million, and its net losses
doubled to around $99 million. The growth kept coming; the losses grew faster.

That divergence — revenue rising while credit losses rise faster and the bottom line deteriorates — is the
classic early signature of a lending business whose growth is outrunning the quality of the credit it is
extending. It is what happens when a lender chases volume into a deteriorating borrower pool: the top line looks
great right up until the loan losses catch up with it. Klarna is not a fringe player; it is one of the largest
BNPL companies in the world, recently public, a bellwether for the entire model. Its doubling losses are not
proof of imminent collapse, but they are exactly the tremor a forensic reader watches for — the place where the
debt that the system cannot see begins, finally, to show up as a number someone has to report. And it is worth
remembering that a credit loss reported today reflects loans made months ago, in better conditions; the losses on
the loans being written now, into a more stretched consumer, will not surface until later still. Reported credit
losses are a rear-view mirror, and the road behind already looks worse than the dashboard admits. When the
fastest-growing lender to the subprime consumer is watching its losses double while its revenue climbs, the
prudent assumption is not that the problem has peaked but that it has barely begun to be measured.
